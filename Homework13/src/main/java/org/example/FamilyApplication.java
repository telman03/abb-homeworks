...
import org.example.Abstracts.DAO.FamilyController;
import org.example.Abstracts.DAO.FamilyDao;
import org.example.Abstracts.DAO.FamilyService;
import org.example.Abstracts.DAO.Implementation.FamilyCollectionDao;
import org.example.Logging.MyLogger;
import org.example.Model.Family;
import org.example.Model.Human;
import org.example.Model.Humans.Man;
import org.example.Model.Humans.Woman;
import org.example.Model.Pets.Dog;
import org.example.Model.Pets.DomesticCat;
...
public class FamilyApplication {
    ...
    private void fillWithTestData() throws ParseException {
        ...
        Family rockFamily = CONTROLLER.createNewFamily(motherJane, fatherJohn);
        ...
        Pet catCap = new DomesticCat("Cap", 3, 64, habits);
        CONTROLLER.addPet(rockFamily, dogMax);
        CONTROLLER.addPet(newFamily, catCap);
        CONTROLLER.bornChild(rockFamily);
